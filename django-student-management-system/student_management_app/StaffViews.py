...
def staff_take_attendance(request):
    ...
    # classes = Subjects.objects.raw('Select c.* from student_management_app_subjects s join student_management_app_courses c on c.id = s.course_id_id join student_management_app_staffs st on st.id = s.staff_id_id where st.id = 2')
    context = {
        "subjects": subjects,
